...
public class EntityAdam extends ElementsNSFW.ModElement {
	public static final int ENTITYID = 3;
	public static final int ENTITYID_RANGED = 4;
	public EntityAdam(ElementsNSFW instance) {
		super(instance, 8);
	}

	@Override
	public void initElements() {
		elements.entities.add(() -> EntityEntryBuilder.create().entity(EntityCustom.class).id(new ResourceLocation("nsfw", "adam"), ENTITYID)
				.name("adam").tracker(64, 3, true).egg(-13421569, -16777012).build());
	}
	...
	public void init(FMLInitializationEvent event) {
		...
		DungeonHooks.addDungeonMob(new ResourceLocation("nsfw:adam"), 180);
	}
		...
		RenderingRegistry.registerEntityRenderingHandler(EntityCustom.class, renderManager -> {
			RenderBiped customRender = new RenderBiped(renderManager, new ModelBiped(), 0.5f) {
				protected ResourceLocation getEntityTexture(Entity entity) {
					return new ResourceLocation("nsfw:textures/adam.png");
				}
			};
